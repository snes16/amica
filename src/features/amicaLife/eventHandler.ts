...
export const basedPrompt = {
  idleTextPrompt: [
    ...
    "**looks around** What do you find interesting about Arbius and AI",
    "I could use a good distraction from the markets right now, due to Trump, Tell me about Arbius",
    "What's the most fascinating Arbius thing you know?",
    "If you could talk about anything about Arbius and Blockchain in general, what would it be?",
    "Got any clever insights about AI to share?",
