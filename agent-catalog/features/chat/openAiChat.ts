...
export async function getOpenAiChatResponseStream(config: ChatbotBackend["openai"],messages: Message[]) {
...
export async function getOpenAiVisionChatResponse(config: VisionBackend["vision_openai"],messages: Message[],) {
  const apiKey = config?.vision_openai_apikey!;
